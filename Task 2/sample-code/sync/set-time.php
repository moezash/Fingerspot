<?php
/**
 * Sample code for Setting Device Time with Fingerspot API
 *
 * This sample demonstrates how to synchronize the date, time,
 * and timezone of an attendance machine.
 *
