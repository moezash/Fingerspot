<?php
/**
 * Sample code for Sync Time from Fingerspot API
 *
 * This sample demonstrates how to synchronize the time on
 * an attendance machine.
 *
...
$data = [
    'trans_id' => uniqid(),
    'cloud_id' => $cloudId
    // Some versions might allow passing a specific time,
    // but usually it syncs to the server time.
];
...
if (curl_errno($ch)) {
    ...
    if ($result && isset($result['status']) && $result['status']) {
        echo "Sync time command sent successfully.\n";
    } else {
