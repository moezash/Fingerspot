 ...
 * - Documentation recommends a maximum range of 2 days per request.
 *
...
// 2. Prepare Data
// Fingerspot recommends small date ranges (max 2 days) for optimal performance
$data = [
