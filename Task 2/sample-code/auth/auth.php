...
// Most endpoints also require 'Content-Type: application/json'.
$headers = [
...
/**
 * Helper function to demonstrate how headers are used in a typical cURL request
 */
function callFingerspotAPI($url, $method = 'POST', $data = null, $headers = []) {
    $ch = curl_init($url);
    ...
    return [
        'http_code' => $httpCode,
        'response'  => ($decoded === null) ? ['status' => false, 'message' => 'Invalid JSON response'] : $decoded
    ];
}
