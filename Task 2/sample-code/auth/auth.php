...
// and 'Content-Type: application/json' for sending JSON data.
$headers = [
...
function testAuthentication($url, $headers) {
    ...
    // For local testing, SSL verification can be disabled.
    // In production, it's recommended to enable it (set to true).
...
echo "\nThis file provides a template for authentication. Use these headers in all your API requests.\n";
